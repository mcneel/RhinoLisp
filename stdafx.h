...
#include "RhinoSdk.h"                            // Rhino SDK classes
#include "RhRdkHeaders.h"                        // Rhino Render Development Kit (RDK) classes
#include "rhinoSdkPlugInLinkingPragmas.h"        // Rhino SDK linking pragmas
